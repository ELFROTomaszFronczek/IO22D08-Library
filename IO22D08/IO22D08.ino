...
// uncomment NANO_AS_MINI if NANO is used

// if MINI IS USED - YOU CAN GET POWER VLOTAGE
//conect 1k to ground and A7
//connect 16k from A7 to power diode near capacitors and power supply
